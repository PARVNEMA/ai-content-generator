export default [
	...
	},
	{
		...
		form: [
			{
				label:
					"Enter text that you want to re-write or improve",
				field: "textarea",
				name: "textToImprove",
			},
		],
	...
	{
		name: "Linkdeln Post Generator",
		desc: "An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.",
		icon: "https://cdn-icons-png.flaticon.com/128/3536/3536505.png",
		category: "blog",
		slug: "Linkdeln-Post-Generator",
		aiPrompt:
			"Generate 1 Linkdeln post depends on a given keywords and give output in  in rich text editor format",
		form: [
			{
	...
	},
	{
		...
		form: [
			{
				label:
					"Enter Keywords / Niche for your instagram idea",
				field: "input",
				name: "keywords",
				required: true,
			},
	...
	},
	{
		...
		form: [
			...
			{
				label:
					"Enter youtube video Outline here (Optional)",
				field: "textarea",
				name: "outline",
			},
		],
